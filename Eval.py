...
if args.pretrained is True:
    model.load_state_dict(
        torch.load('./results/{}/Best-Model-bsize{}-pt.pth'.format(args.model, args.bsize))['state_dict'])
else:
    model.load_state_dict(
        torch.load('./results/{}/Best-Model-bsize{}.pth'.format(args.model, args.bsize))['state_dict'])
